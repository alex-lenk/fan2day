...
class Fun2DayPackage
{
    ...
    {
        if (strpos(MODX_BASE_PATH, 'ilyasterc') !== false) {
            system('cp -Rf ' . MODX_CORE_PATH . 'components/fun2day ' . dirname(__DIR__) . '/core/components/');
            system('cp -Rf ' . MODX_BASE_PATH . 'assets/components/fun2day ' . dirname(__DIR__) . '/assets/components/');
        }
...
$install = new Fun2DayPackage(MODX_CORE_PATH, $config);
