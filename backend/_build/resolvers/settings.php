...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    ...
    case xPDOTransport::ACTION_UPGRADE:
        ...
        $tmp->fromArray(array(
            ...
            'area'      => 'furls',
            'xtype'     => 'textfield',
            'value'     => file_get_contents($modx->getOption('core_path') . 'components/fun2day/docs/friendly_alias_restrict_chars_pattern.txt'),
        ...
        if (!$tmp = $modx->getObject('modSystemSetting', array('key' => 'pdotools_elements_path'))) {
            $tmp = $modx->newObject('modSystemSetting');
        }
        $tmp->fromArray(array(
            'namespace' => 'pdotools',
            'area'      => 'pdotools_main',
            'xtype'     => 'textfield',
            'value'     => '{core_path}components/fun2day/elements/',
