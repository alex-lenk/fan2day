    ...
    <div class="modal-box">
        ...
        <form id="modal-login" class="modal-form">
            ...
            <div class="form-group">
                <input type="email" name="email" class="form-control hide-placeholder" placeholder="Введите e-mail *">
            </div>
            <div class="form-group">
        ...
        <form id="modal-forgot" class="modal-form">
            ...
            <div class="form-group">
                <input type="email" name="inputForgotEmail" class="form-control hide-placeholder" placeholder="E-mail *">
            </div>
            <div class="form-group__btn">
        ...
        <form id="modal-register" class="modal-form">
            ...
            <div class="form-group">
                <input type="email" name="inputRegisterEmail" class="form-control hide-placeholder" placeholder="Укажите Ваш E-mail *">
            </div>
